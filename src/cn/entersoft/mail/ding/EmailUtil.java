...
public class EmailUtil {
	...
	public static void main(String[] args){
		...
		EmailUtil email = new EmailUtil("smtp.163.com", 25, 1, true, "entertest111@163.com","enter123",false);
		Collection col = new ArrayList();
		try{
			email.sendEmail(
					"entertest111@163.com",
					"dd",
					"xiaoliy88@126.com",
					"mail subject: how are you?",
					"<html><body><font color='red'>can you see?ÖÐ¹ú</font></body></html>",
					col);
